...
export const Footer = ({ className = "" }: Props) => {
  return (
    <footer className={`bg-card py-12 px-4 border-t border-border ${className}`}>
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-bold">BiteBase</h2>
            </div>
            <p className="text-sm text-muted-foreground">
              Data-driven market intelligence for restaurant entrepreneurs and operators.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} BiteBase Intelligence. All rights reserved.
            </p>
